...
from RgNormResNet_3.models.gumbel_sigmoid import GumbelSigmoid
...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_features=3, num_classes=10, tau=0.1, image_size=(32, 32)):
    ...
    def forward(self, x, is_eval=False):
        ...
        out = self.linear(out)
        return out
        # outputs = out + r_outputs+nr_outputs+rec_outputs
        # return outputs
        # return out, r_outputs, nr_outputs, rec_outputs


def ResNet18_FSR(in_features=3, num_classes=10, tau=0.1, image_size=(32, 32)):
    return ResNet(BasicBlock, [2, 2, 2, 2], in_features=in_features, num_classes=num_classes, tau=tau, image_size=image_size)
